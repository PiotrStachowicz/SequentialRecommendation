...
asin2item_df = pd.read_csv('dict/Clothing_Shoes_and_Jewelry/asin2itemID.csv')
item_final_df = pd.read_csv('dict/Clothing_Shoes_and_Jewelry/item_final.csv')

asin_list = np.load('datasets/Clothing_Shoes_and_Jewelry100logistic/asinlist.npy', allow_pickle=True)
